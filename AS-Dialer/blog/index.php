            ...
            <main id="main" class="site-main clr" role="main">
                <header class="page-header">
                    <div class="container clr page-header-inner">
                        <h2 class="page-header-title clr" itemprop="headline">Blogs</h2>
                        <nav class="site-breadcrumbs clr"><span><span><a href="../index.php">Home</a> » <span class="breadcrumb_last" aria-current="page">Blogs</span></span></span></nav>
                ...
                <div data-elementor-type="archive" data-elementor-id="356" class="elementor elementor-356 elementor-location-archive">
                    <div class="elementor-section-wrap">
                        ...
                        <section>
                            <div style="margin-top:60px" class="container col-lg-9 col-md-12 col-sm-12 ms-3">
                                <div class="container" style="background:#FFC700; height:60vh; border-radius:38px ">
                                  <div class="row">
